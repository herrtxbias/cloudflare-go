...
func TestDestinationPagerdutyNew(t *testing.T) {
	...
	_, err := client.Alerting.Destinations.Pagerduty.New(context.TODO(), alerting.DestinationPagerdutyNewParams{
...
func TestDestinationPagerdutyDelete(t *testing.T) {
	...
	_, err := client.Alerting.Destinations.Pagerduty.Delete(context.TODO(), alerting.DestinationPagerdutyDeleteParams{
		AccountID: cloudflare.F("023e105f4ecef8ad9ca31a8372d0c353"),
	})
	if err != nil {
		var apierr *cloudflare.Error
...
func TestDestinationPagerdutyGet(t *testing.T) {
	...
	_, err := client.Alerting.Destinations.Pagerduty.Get(context.TODO(), alerting.DestinationPagerdutyGetParams{
		AccountID: cloudflare.F("023e105f4ecef8ad9ca31a8372d0c353"),
	})
	if err != nil {
		var apierr *cloudflare.Error
...
func TestDestinationPagerdutyLink(t *testing.T) {
	...
	_, err := client.Alerting.Destinations.Pagerduty.Link(
		context.TODO(),
		"8c71e667571b4f61b94d9e4b12158038",
		alerting.DestinationPagerdutyLinkParams{
			AccountID: cloudflare.F("023e105f4ecef8ad9ca31a8372d0c353"),
		},
	)
	if err != nil {
