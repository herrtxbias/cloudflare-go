...
<a href="https://pkg.go.dev/github.com/herrtxbias/cloudflare-go/v4"><img src="https://pkg.go.dev/badge/github.com/herrtxbias/cloudflare-go/v4.svg" alt="Go Reference"></a>
...
```go
import (
	"github.com/herrtxbias/cloudflare-go/v4" // imported as cloudflare
)
```
...
```sh
go get -u 'github.com/herrtxbias/cloudflare-go/v4@v4.1.0'
```
...
See the [full list of request options](https://pkg.go.dev/github.com/herrtxbias/cloudflare-go/v4/option).
