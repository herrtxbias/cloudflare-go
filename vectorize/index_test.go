...
func TestIndexNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Vectorize.Indexes.New(context.TODO(), vectorize.IndexNewParams{
		AccountID: cloudflare.F("023e105f4ecef8ad9ca31a8372d0c353"),
		Config: cloudflare.F[vectorize.IndexNewParamsConfigUnion](vectorize.IndexDimensionConfigurationParam{
			Dimensions: cloudflare.F(int64(768)),
			Metric:     cloudflare.F(vectorize.IndexDimensionConfigurationMetricCosine),
		}),
...
func TestIndexList(t *testing.T) {
	...
	_, err := client.Vectorize.Indexes.List(context.TODO(), vectorize.IndexListParams{
		AccountID: cloudflare.F("023e105f4ecef8ad9ca31a8372d0c353"),
	})
	if err != nil {
		var apierr *cloudflare.Error
...
func TestIndexDelete(t *testing.T) {
	...
	_, err := client.Vectorize.Indexes.Delete(
		context.TODO(),
		"example-index",
...
func TestIndexDeleteByIDsWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
...
func TestIndexGetByIDsWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
...
func TestIndexInsertWithOptionalParams(t *testing.T) {
	...
	_, err := client.Vectorize.Indexes.Insert(
		context.TODO(),
		"example-index",
...
func TestIndexQueryWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.Vectorize.Indexes.Query(
		context.TODO(),
		"example-index",
		vectorize.IndexQueryParams{
			AccountID: cloudflare.F("023e105f4ecef8ad9ca31a8372d0c353"),
			Vector:    cloudflare.F([]float64{0.500000, 0.500000, 0.500000}),
			Filter: cloudflare.F[any](map[string]interface{}{
...
func TestIndexUpsertWithOptionalParams(t *testing.T) {
	...
	_, err := client.Vectorize.Indexes.Upsert(
		context.TODO(),
		"example-index",
