...
func TestIndexMetadataIndexNew(t *testing.T) {
	...
	_, err := client.Vectorize.Indexes.MetadataIndex.New(
		context.TODO(),
		"example-index",
...
func TestIndexMetadataIndexList(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.Vectorize.Indexes.MetadataIndex.List(
		context.TODO(),
		"example-index",
...
func TestIndexMetadataIndexDelete(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.Vectorize.Indexes.MetadataIndex.Delete(
		context.TODO(),
		"example-index",
