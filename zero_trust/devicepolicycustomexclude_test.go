...
func TestDevicePolicyCustomExcludeUpdate(t *testing.T) {
	...
	_, err := client.ZeroTrust.Devices.Policies.Custom.Excludes.Update(
		context.TODO(),
		"f174e90a-fafe-4643-bbbc-4a0ed4fc8415",
		zero_trust.DevicePolicyCustomExcludeUpdateParams{
...
func TestDevicePolicyCustomExcludeGet(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.ZeroTrust.Devices.Policies.Custom.Excludes.Get(
		context.TODO(),
		"f174e90a-fafe-4643-bbbc-4a0ed4fc8415",
