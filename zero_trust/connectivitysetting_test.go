...
func TestConnectivitySettingEditWithOptionalParams(t *testing.T) {
	...
	_, err := client.ZeroTrust.ConnectivitySettings.Edit(context.TODO(), zero_trust.ConnectivitySettingEditParams{
...
func TestConnectivitySettingGet(t *testing.T) {
	...
	_, err := client.ZeroTrust.ConnectivitySettings.Get(context.TODO(), zero_trust.ConnectivitySettingGetParams{
		AccountID: cloudflare.F("699d98642c564d2e855e9661899b7252"),
	})
	if err != nil {
		var apierr *cloudflare.Error
