...
func TestDevicePolicyDefaultFallbackDomainUpdate(t *testing.T) {
	...
	_, err := client.ZeroTrust.Devices.Policies.Default.FallbackDomains.Update(context.TODO(), zero_trust.DevicePolicyDefaultFallbackDomainUpdateParams{
		...
		Domains: []zero_trust.FallbackDomainParam{{
			...
			DNSServer:   cloudflare.F([]string{"1.1.1.1"}),
		}},
	})
	if err != nil {
...
func TestDevicePolicyDefaultFallbackDomainGet(t *testing.T) {
	...
	_, err := client.ZeroTrust.Devices.Policies.Default.FallbackDomains.Get(context.TODO(), zero_trust.DevicePolicyDefaultFallbackDomainGetParams{
		AccountID: cloudflare.F("699d98642c564d2e855e9661899b7252"),
	})
	if err != nil {
		var apierr *cloudflare.Error
