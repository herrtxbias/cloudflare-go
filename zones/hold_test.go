...
func TestHoldNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Zones.Holds.New(context.TODO(), zones.HoldNewParams{
...
func TestHoldDeleteWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
...
func TestHoldEditWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
...
func TestHoldGet(t *testing.T) {
	...
	_, err := client.Zones.Holds.Get(context.TODO(), zones.HoldGetParams{
		ZoneID: cloudflare.F("023e105f4ecef8ad9ca31a8372d0c353"),
	})
	if err != nil {
		var apierr *cloudflare.Error
