...
func TestCustomNameserverUpdateWithOptionalParams(t *testing.T) {
	...
	_, err := client.Zones.CustomNameservers.Update(context.TODO(), zones.CustomNameserverUpdateParams{
...
func TestCustomNameserverGet(t *testing.T) {
	...
	_, err := client.Zones.CustomNameservers.Get(context.TODO(), zones.CustomNameserverGetParams{
		ZoneID: cloudflare.F("023e105f4ecef8ad9ca31a8372d0c353"),
	})
	if err != nil {
		var apierr *cloudflare.Error
